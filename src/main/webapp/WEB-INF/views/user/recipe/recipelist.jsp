						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="recipedetail?reNo=${ list[0] }&memId=test"><img id="resultimg" src="/resources/user/recipeimages/${ list[4] }" alt=""></a>
								</div>
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="recipedetail?reNo=${ list[0] }&memId=test">${ list[1] }</a></h4></div>
