		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<form method="get" name="form" action="reportupdate">
					...
					<input name="reportSusid" type="hidden"
						value="${boList.reportSusid}" />
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<div class="card-body">
									...
									<div class="form-group">
										<label for="inputStatus">신고 타입</label> <select
											id="inputStatus" name="reportApply"
					...
					<div class="row">
						<div class="col-12">
							...
							<input type="submit" value="등록"
								...
								onclick="javascript: form.action='reportupdate';">
						</div>
					</div>
				</form>
			</section>
