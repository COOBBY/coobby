...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <input name="reportNo" type="hidden" value="${coList.reportNo}" />
    <input name="reportSusid" type="hidden" value="${coList.reportSusid}" />
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div  id="inputName" class="form-control">${coList.reportSusid }</div>
              </div>
              <div class="form-group">
                <label for="inputClientCompany">신고자</label>
               <div  id="inputName" class="form-control">${coList.reportVicid }</div>
              </div>
              <div class="form-group">
                <label for="inputDescription">작성 내용</label>
                <textarea id="inputDescription" class="form-control" rows="4">${coList.reportContent }</textarea>
              </div>
